...
export default function LoginForm() {
  ...
  async function handleOAuth(provider: "google" | "github") {
    ...
    // so there is no need to reset the loading state.
  }
  ...
  return (
    <AuthShell
      ...
      subtitle="Pick up where you left off in your courses and dashboard."
      footer={
        <>
      ...
      >
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/login/reset"
              className="mb-1.5 text-xs font-medium text-indigo-400 transition hover:text-indigo-300"
            >
              Forgot password?
            </Link>
          </div>
